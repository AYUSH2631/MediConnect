...
import com.mediconnect.doctor.services.DoctorService;
...
public class DoctorController {
    ...
    @PostMapping
    public ResponseEntity<?> saveDoctor(@Valid @RequestBody com.mediconnect.doctor.payload.request.Doctor doctor) throws Exception {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateDoctor(@Valid @RequestBody com.mediconnect.doctor.payload.request.Doctor doctor, @PathVariable String id) throws Exception {
        try {
